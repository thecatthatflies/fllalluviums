...
const scale = 1;
export const halfSize = tilesPerAxis * tileSize * 0.5 * scale;

const base1 = new Vector2(0.0015, 300);
const base2 = new Vector2(0.004, 0.12);
const base3 = new Vector2(0.009, 0.05);

const erosion = new Vector3(0.004, 0.01, 0.06);

const hill = new Vector2(0.015, 60);
