...
/*glsl*/`
    ...
    void main()
    {
        float dirLighting = max(0.35, dot(_normal, _DirToLight));
        vec3 color = _BaseColor * dirLighting;
        ...
        gl_FragColor = vec4(mix(color * light, light, min(viewLen / MAX_VIEW_DEPTH, 1.0 - spotLight)), 1.0);
    }
`;
