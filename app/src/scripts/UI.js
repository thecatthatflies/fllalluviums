...
export function Start() {
    ...
    class Range {
        ...
        constructor(text, parent, min, max, step, value, unit, anisotropy) {
            ...
            this.element.style.background = "linear-gradient(to right, rgba(90,160,255,0.9) 0%, rgba(90,160,255,0.9) " + p + ", rgba(255,255,255,0.1) " + p + ", rgba(255,255,255,0.1) 100%)";
    ...
    //#region Menu buttons
    newButton("Resume simulation", menuDiv, menuButton, false, true);
    ...
    touchControlsIn.clickArea.onclick = function () {
        ...
        if (touchControls) {
            ...
            if (spotLightDistanceUniform.value > 0) {
                touchControlButtons[2].style.backgroundColor = "rgba(255,255,255,0.2)";
            }
            else {
                touchControlButtons[2].style.backgroundColor = "rgba(255,255,255,0.08)";
            }
        }
        else {
            for (let i = 0; i < touchControlButtons.length; i++) {
    ...
    newInputInfo(false, "The mockup app built for the FIRST LEGO League team, \"Alluviums\", team #46300. Thanks to @Nugget8 on GitHub for the original model. Learn more about this project:", aboutInfoDiv);
    const a = document.createElement("a");
    a.href = "https://fllalluviums.com";
    a.textContent = "https://fllalluviums.com";
