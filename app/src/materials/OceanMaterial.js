...
export const kelp = new ShaderMaterial();
...
const objectTexture = new TextureLoader().load("images/sand.png");
...
export function Start() {
    ...
    kelp.vertexShader = OceanShaders.kelpVertex;
    kelp.fragmentShader = OceanShaders.kelpFragment;
    kelp.side = DoubleSide;
    kelp.uniforms =
    {
        _BaseColor: new Uniform(new Vector3(0.18, 0.42, 0.14)),
        _CameraForward: new Uniform(cameraForward),
        _SpotLightSharpness: new Uniform(spotLightSharpness),
        _SpotLightDistance: spotLightDistanceUniform
    };
    SetSkyboxUniforms(kelp);
}